...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		new HMM("data/DennisSchwartz_train.txt","data/DennisSchwartz_test.txt","data/DennisSchwartz_test_results.txt", "dennis");
		new HMM("data/ScottRenshaw_train.txt","data/ScottRenshaw_test.txt","data/ScottRenshaw_test_results.txt", "scott");
